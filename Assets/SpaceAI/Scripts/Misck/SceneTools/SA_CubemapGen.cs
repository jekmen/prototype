...
{
    public class SA_CubemapGen : MonoBehaviour
    {
        /// <summary>
        ...
        /// Default file name: using current time SA_hh_mm_ss.png 
        ...
        public static bool SaveCubemapCapture(Cubemap cubemap, string pathName = null)
        {
            ...
            {
                dirName = Application.persistentDataPath + "/ScreenShot360/";
                fileName = null;
            }
            else
            {
            ...
            if (string.IsNullOrEmpty(fileName))
                fileName = "SA_" + System.DateTime.Now.ToString("hh_mm_ss") + ".png";
            ...
            if (tex == null)
            {
                Debug.LogError("Failed creating the texture!");
                return false;
            }
