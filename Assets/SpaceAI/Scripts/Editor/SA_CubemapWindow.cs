...
{
    public class SA_CubemapWindow : ScriptableWizard
    {
        ...
        void OnWizardCreate()
        {
            ...
            foreach (string fileName in fileNames)
            {
                ...
                string temp = fileName.Replace(cubeMapFolder + "screenshot_", string.Empty);
            ...
            string pathName = string.Format("{0}screenshot_{1}.cubemap", cubeMapFolder, (++idx).ToString("d2"));
            ...
            if ((camera != null) && (cubemap != null))
            {
                ...
                SA_CubemapGen.RenderIntoCubemap(camera, cubemap);
                if (existingCamera)
                {
        ...
        void GenerateTexture(Cubemap cubemap, string pathName)
        {
            ...
            if (!string.IsNullOrEmpty(fullPath))
            {
                ...
                SA_CubemapGen.SaveCubemapCapture(cubemap, fullPath);
            }
        }
        ...
        /// </summary>
        [MenuItem("Space AI Tools/Cubemap Wizard", false, 100000)]
        static void TakeOVRScreenshot()
        {
            SA_CubemapWindow wizard = DisplayWizard<SA_CubemapWindow>("Cubemap Wizard", "Render Cubemap");
            if (wizard != null)
            {
