...
{
    [CustomEditor(typeof(SA_AsteroidsManager))]
    public class SA_AsteroidFieldEditor : Editor
    {
        ...
        SerializedProperty minAsteroidResources;
        SerializedProperty maxAsteroidResources;
        SerializedProperty ResourcesMultiplier;
        ...
        void OnEnable()
        {
            ...
            minAsteroidResources = myTarget.FindProperty("minAsteroidResources");
            maxAsteroidResources = myTarget.FindProperty("maxAsteroidResources");
            ResourcesMultiplier = myTarget.FindProperty("ResourcesMultiplier");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("Resorce Capacity", EditorStyles.boldLabel);
            _minScale = minAsteroidResources.floatValue;
            _maxScale = maxAsteroidResources.floatValue;
            GUIContent _scaleContentRes = new GUIContent(string.Format("Min:{0:F1}, Max:{1:F1}", _minScale, _maxScale));
            EditorGUILayout.MinMaxSlider(_scaleContentRes, ref _minScale, ref _maxScale, 0.1f, 1.0f);
            minAsteroidResources.floatValue = _minScale;
            maxAsteroidResources.floatValue = _maxScale;
            ResourcesMultiplier.floatValue = EditorGUILayout.FloatField("Resorces Multiplier", ResourcesMultiplier.floatValue);
            EditorGUILayout.Separator();
            ...
            if (polyCountCollider.enumValueIndex != (int)SA_Asteroid.PolyCount.LOW)
            {
